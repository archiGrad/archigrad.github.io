...
DEFAULTS = {
    ...
    'PIPELINE_ORDER': ['sharpen', 'blur', 'contrast', 'exposure', 'gamma', 'color_to_transparent', 'alpha_outline', 'dither', 'invert', 'pixelate', 'fill', 'colorize', 'color_replace', 'rectangle', 'line', 'edge_outline', 'grain'],
...
def scan_folder(path, parent_hidden=False, inherited_spacing=None, inherited_zoom=None, inherited_keywords=None, inherited_reverse=None, inherited_sprite_bg=None, inherited_sprite_bg_opacity=None, inherited_sprite_bg_crop=None, inherited_sprite_bg_crop_opacity=None, ignore=None):
    if ignore is None:
...
async function createThreeScene(container, images, node, highlightPath) {{
    ...
    const RANDOM_IMAGE_ROTATION = spriteConfig.random_image_rotation;
    const DISCRETE_IMAGE_ROTATION = spriteConfig.discrete_image_rotation;
    const DISCRETE_IMAGE_ROTATION_ANGLE = spriteConfig.discrete_image_rotation_angle;
    const RANDOM_STACK_ROTATION = spriteConfig.random_stack_rotation;
    const DISCRETE_STACK_ROTATION = spriteConfig.discrete_stack_rotation;
    const DISCRETE_STACK_ROTATION_ANGLE = spriteConfig.discrete_stack_rotation_angle;
    const RANDOM_GROUP_ROTATION = spriteConfig.random_group_rotation;
    const DISCRETE_GROUP_ROTATION = spriteConfig.discrete_group_rotation;
    const DISCRETE_GROUP_ROTATION_ANGLE = spriteConfig.discrete_group_rotation_angle;
    const IMAGE_ROTATION_PERCENTAGE = spriteConfig.image_rotation_percentage;
    const STACK_ROTATION_PERCENTAGE = spriteConfig.stack_rotation_percentage;
    const GROUP_ROTATION_PERCENTAGE = spriteConfig.group_rotation_percentage;
