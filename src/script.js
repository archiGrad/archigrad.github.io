...
function createStacksOfPlanes(students) {
    ...
    for (var i = 0; i < stackCount; i++) {
        ...
        for (var j = 0; j < itemCount; j++) {
            ...
            var randomV = Math.ceil(Math.random() * (itemCount - 1)) ;
            // var randomV = 1 //set percentage, 0==0% 1==100& 
            if (j % (randomV) == 0) {
                ...
                if (Object.keys(conversations).includes(student)) {
                    ...
                    for (let conversation of studentConversations) {
