const conversations = {
    ...
    'an': [
        [
            ...
            { type: "you", content: "To the collaborative symphony of minds! 🎨🎓" },
        ],
    ],
    "ik": [
        [
            { type: "you", content: "Social media, obvs! We need an Insta for our holographic memes and a TikTok for our time-travel dance moves. 💃🕺" },
    ...
    "tur": [
        [
            ...
            { type: "you", content: "Our AI curator can roast bad predictions and make history hilarious. 🤖🔥" },
        ],
    ],
    "axel": [
        [
    ...
    "lev": [
        [
            { type: "me", content: "absolutely! Imagine archives that not only preserve the past but also prepare for the future. 🚀" },
